...
OUT_JSON = Path("artifacts/residual_simplex/comparison_trained_vs_control_dim24_prob_kl.json")
OUT_JSON_LAYER1 = Path("artifacts/residual_simplex/comparison_trained_vs_control_dim24_prob_kl_layer1.json")
